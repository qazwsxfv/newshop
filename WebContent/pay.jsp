									...
									<li class="user-addresslist">
										<div class="address-left">
										    ...
										    <div class="user DefaultAddr">
												 <span class="buy-address-detail"></span>
		                  						 <span class="">电话</span>
												 <span class="buy-phone">${assse}</span>
											</div>
								...
								<div class="bundle  bundle-last">
									...
									<div class="bundle-main">
										<ul class="item-content clearfix">
													...
													<div class="item-price price-promo-promo">
														<div class="price-content">
															<div class="price-line">
																<em class="price-original">${good.goods_price_off}</em>
															</div>
															<div class="price-line"> 
																<em class="J_Price price-now" id="priceNow" tabindex="0">${good.goods_price}</em>
															</div>
														</div>
													</div>
												</li>
											...
											<li class="td td-sum">
												<div class="td-inner">
													<em tabindex="0" class="J_ItemSum number" id="singlePrice"><fmt:formatNumber type="number" value="${good.count*good.goods_price}" maxFractionDigits="2"/></em>
												</div>
											</li>
							...
							<div class="order-go clearfix">
								<div class="pay-confirm clearfix">
									...
									<div id="holyshit269" class="submitOrder">
										...
										<form action="ShoppingServlet?action=sumbitOrder" method="post" id="form">
