...
<body>
    ...
    <form action="GoodsInfoServlet?action=update" method="post">
	    ...
	    <li><label>所属大类</label>
	    		<select name="gtype_parentid" id="gtype_parentid">
	    		<c:forEach items="${bigList}" var="goodsType">
						<option value="${goodsType.gtype_parentid}">${goodsType.gtype_name}</option>
					</c:forEach>
	    		</select>
